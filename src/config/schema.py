    ...
    return deepcopy(
        {
            ...
            "bot": {
                "long": {
                    "dca_price_deviation_pct": 0.01,
                    "dca_step_scale": 1.0,
                    "dca_volume_scale": 1.28,
                    "dca_so1_ratio": 1.0,
                    "dca_max_safety_orders": 20,
            ...
            "optimize": {
                "bounds": {
                    "long_dca_price_deviation_pct": [0.002, 0.03, 0.0001],
                    "long_dca_step_scale": [0.8, 1.5, 0.01],
                    "long_dca_volume_scale": [1.0, 2.0, 0.01],
                    "long_dca_so1_ratio": [0.5, 2.0, 0.01],
                    "long_dca_max_safety_orders": [5, 30, 1],
                    "long_dca_take_profit_pct": [0.005, 0.05, 0.0001],
                    ...
                    "long_n_rescue_fav": [4, 20, 1],
                    "long_n_rescue_rev": [2, 10, 1],
                    "long_rescue_grid_step_scale": [1.0, 1.5, 0.01],
                    "short_dca_price_deviation_pct": [0.002, 0.03, 0.0001],
                    "short_dca_step_scale": [0.8, 1.5, 0.01],
                    "short_dca_volume_scale": [1.0, 2.0, 0.01],
                    "short_dca_so1_ratio": [0.5, 2.0, 0.01],
                    "short_dca_max_safety_orders": [5, 30, 1],
                    "short_dca_take_profit_pct": [0.005, 0.05, 0.0001],
                    ...
                    "short_n_rescue_fav": [4, 20, 1],
                    "short_n_rescue_rev": [2, 10, 1],
                    "short_rescue_grid_step_scale": [1.0, 1.5, 0.01],
                },
                "backend": "pymoo",
